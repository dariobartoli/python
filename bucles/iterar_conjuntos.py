#igual al apartado de listas, convierto las listas en conjunto para ver si funciona, el unico metodo que no funciona es el metodo no optimo de len
...
#Todo ESTOS METODOS FUNCIONAN TAMBIEN CON LISTAS Y TUPLAS